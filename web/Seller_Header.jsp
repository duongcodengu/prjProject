...
<header class="bg-light py-2">
    <div class="container-fluid d-flex justify-content-between">
        ...
        <a href="ProductManagerServlet" class="mx-3">Product Manager</a>


        <div>

            <a href="soldProducts"" class="mx-2">sold products</a>
            <a href="#" class="mx-2">Sell</a>
